...
atom() ->
    ?assertError(function_clause, bubblesort:bubblesort(abc)).

integer() ->
    ?assertError(function_clause, bubblesort:bubblesort(123)).

float() ->
    ?assertError(function_clause, bubblesort:bubblesort(1.1)).
